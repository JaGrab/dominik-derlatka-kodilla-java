...
public class CustomerTestSuite {
    ...
    public void testDefaultInvestingStrategies() {
        ...
        Customer kodilla = new CoroporateCustomer("Kodilla");

        //When
        String stevenShouldBuy = steven.share();
        System.out.println("Steven should: " + stevenShouldBuy);
        String johnShouldBuy = john.share();
        System.out.println("John should: " + johnShouldBuy);
        String kodillaShouldBuy = kodilla.share();
